...
import TransitionSection from '@/components/ui/transition/transitionSection';
...
const Home = () => {
    ...
    return (
        <>
            ...
            <section id='sobre' className='bg-gradient-radial from-[#353535] to-[#0A0A0A] px-[8%] pt-[7%] md:pt-[3%] pb-[12%] md:pb-[6%]'>
                <div className='flex flex-col items-center text-justify'>
                    <div className={`w-full ${nameFont.className}`}>
                        ...
                        <h1 className='font-bold text-[14.4vw] leading-[14vw] text-center p-0'>GUIMARÃES</h1>
                    </div>
